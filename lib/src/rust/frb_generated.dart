...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 773382135;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  void crateApiQjsDisableProxy() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiQjsDisableProxyConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiQjsDisableProxyConstMeta =>
      const TaskConstMeta(debugName: "disable_proxy", argNames: []);
