...
mixin _$BikaSettingState {
 ...
 String get account; String get password; String get authorization; int get level; int get proxy; String get imageQuality; Map<String, bool> get shieldCategoryMap; Map<String, bool> get shieldHomePageCategoriesMap; bool get signIn; bool get brevity; bool get slowDownload;
...
@useResult
$Res call({
 String account, String password, String authorization, int level, int proxy, String imageQuality, Map<String, bool> shieldCategoryMap, Map<String, bool> shieldHomePageCategoriesMap, bool signIn, bool brevity, bool slowDownload
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String account,  String password,  String authorization,  int level,  int proxy,  String imageQuality,  Map<String, bool> shieldCategoryMap,  Map<String, bool> shieldHomePageCategoriesMap,  bool signIn,  bool brevity,  bool slowDownload)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BikaSettingState() when $default != null:
return $default(_that.account,_that.password,_that.authorization,_that.level,_that.proxy,_that.imageQuality,_that.shieldCategoryMap,_that.shieldHomePageCategoriesMap,_that.signIn,_that.brevity,_that.slowDownload);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String account,  String password,  String authorization,  int level,  int proxy,  String imageQuality,  Map<String, bool> shieldCategoryMap,  Map<String, bool> shieldHomePageCategoriesMap,  bool signIn,  bool brevity,  bool slowDownload)  $default,) {final _that = this;
switch (_that) {
case _BikaSettingState():
return $default(_that.account,_that.password,_that.authorization,_that.level,_that.proxy,_that.imageQuality,_that.shieldCategoryMap,_that.shieldHomePageCategoriesMap,_that.signIn,_that.brevity,_that.slowDownload);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String account,  String password,  String authorization,  int level,  int proxy,  String imageQuality,  Map<String, bool> shieldCategoryMap,  Map<String, bool> shieldHomePageCategoriesMap,  bool signIn,  bool brevity,  bool slowDownload)?  $default,) {final _that = this;
switch (_that) {
case _BikaSettingState() when $default != null:
return $default(_that.account,_that.password,_that.authorization,_that.level,_that.proxy,_that.imageQuality,_that.shieldCategoryMap,_that.shieldHomePageCategoriesMap,_that.signIn,_that.brevity,_that.slowDownload);case _:
  return null;
