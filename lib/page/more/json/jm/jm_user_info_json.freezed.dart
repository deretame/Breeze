...
@JsonKey(name: "uid") String get uid;@JsonKey(name: "username") String get username;@JsonKey(name: "email") String get email;@JsonKey(name: "emailverified") String get emailverified;@JsonKey(name: "photo") String get photo;@JsonKey(name: "fname") String get fname;@JsonKey(name: "gender") String get gender;@JsonKey(name: "message") String get message;@JsonKey(name: "coin") int get coin;@JsonKey(name: "album_favorites") int get albumFavorites;@JsonKey(name: "s") String get s;@JsonKey(name: "level_name") String get levelName;@JsonKey(name: "level") int get level;@JsonKey(name: "nextLevelExp") int get nextLevelExp;@JsonKey(name: "exp") String get exp;@JsonKey(name: "expPercent") double get expPercent;@JsonKey(name: "badges") List<dynamic> get badges;@JsonKey(name: "album_favorites_max") int get albumFavoritesMax;@JsonKey(name: "ad_free") bool get adFree;@JsonKey(name: "ad_free_before") String get adFreeBefore;@JsonKey(name: "charge") String get charge;@JsonKey(name: "jar") String get jar;@JsonKey(name: "invitation_qrcode") String get invitationQrcode;@JsonKey(name: "invitation_url") String get invitationUrl;@JsonKey(name: "invited_cnt") String get invitedCnt;@JsonKey(name: "jwttoken") String get jwttoken;
...
@useResult
$Res call({
@JsonKey(name: "uid") String uid,@JsonKey(name: "username") String username,@JsonKey(name: "email") String email,@JsonKey(name: "emailverified") String emailverified,@JsonKey(name: "photo") String photo,@JsonKey(name: "fname") String fname,@JsonKey(name: "gender") String gender,@JsonKey(name: "message") String message,@JsonKey(name: "coin") int coin,@JsonKey(name: "album_favorites") int albumFavorites,@JsonKey(name: "s") String s,@JsonKey(name: "level_name") String levelName,@JsonKey(name: "level") int level,@JsonKey(name: "nextLevelExp") int nextLevelExp,@JsonKey(name: "exp") String exp,@JsonKey(name: "expPercent") double expPercent,@JsonKey(name: "badges") List<dynamic> badges,@JsonKey(name: "album_favorites_max") int albumFavoritesMax,@JsonKey(name: "ad_free") bool adFree,@JsonKey(name: "ad_free_before") String adFreeBefore,@JsonKey(name: "charge") String charge,@JsonKey(name: "jar") String jar,@JsonKey(name: "invitation_qrcode") String invitationQrcode,@JsonKey(name: "invitation_url") String invitationUrl,@JsonKey(name: "invited_cnt") String invitedCnt,@JsonKey(name: "jwttoken") String jwttoken
});
...
/// Create a copy of JmUserInfoJson
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? username = null,Object? email = null,Object? emailverified = null,Object? photo = null,Object? fname = null,Object? gender = null,Object? message = null,Object? coin = null,Object? albumFavorites = null,Object? s = null,Object? levelName = null,Object? level = null,Object? nextLevelExp = null,Object? exp = null,Object? expPercent = null,Object? badges = null,Object? albumFavoritesMax = null,Object? adFree = null,Object? adFreeBefore = null,Object? charge = null,Object? jar = null,Object? invitationQrcode = null,Object? invitationUrl = null,Object? invitedCnt = null,Object? jwttoken = null,}) {
...
as int,albumFavorites: null == albumFavorites ? _self.albumFavorites : albumFavorites // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "uid")  String uid, @JsonKey(name: "username")  String username, @JsonKey(name: "email")  String email, @JsonKey(name: "emailverified")  String emailverified, @JsonKey(name: "photo")  String photo, @JsonKey(name: "fname")  String fname, @JsonKey(name: "gender")  String gender, @JsonKey(name: "message")  String message, @JsonKey(name: "coin")  int coin, @JsonKey(name: "album_favorites")  int albumFavorites, @JsonKey(name: "s")  String s, @JsonKey(name: "level_name")  String levelName, @JsonKey(name: "level")  int level, @JsonKey(name: "nextLevelExp")  int nextLevelExp, @JsonKey(name: "exp")  String exp, @JsonKey(name: "expPercent")  double expPercent, @JsonKey(name: "badges")  List<dynamic> badges, @JsonKey(name: "album_favorites_max")  int albumFavoritesMax, @JsonKey(name: "ad_free")  bool adFree, @JsonKey(name: "ad_free_before")  String adFreeBefore, @JsonKey(name: "charge")  String charge, @JsonKey(name: "jar")  String jar, @JsonKey(name: "invitation_qrcode")  String invitationQrcode, @JsonKey(name: "invitation_url")  String invitationUrl, @JsonKey(name: "invited_cnt")  String invitedCnt, @JsonKey(name: "jwttoken")  String jwttoken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JmUserInfoJson() when $default != null:
return $default(_that.uid,_that.username,_that.email,_that.emailverified,_that.photo,_that.fname,_that.gender,_that.message,_that.coin,_that.albumFavorites,_that.s,_that.levelName,_that.level,_that.nextLevelExp,_that.exp,_that.expPercent,_that.badges,_that.albumFavoritesMax,_that.adFree,_that.adFreeBefore,_that.charge,_that.jar,_that.invitationQrcode,_that.invitationUrl,_that.invitedCnt,_that.jwttoken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "uid")  String uid, @JsonKey(name: "username")  String username, @JsonKey(name: "email")  String email, @JsonKey(name: "emailverified")  String emailverified, @JsonKey(name: "photo")  String photo, @JsonKey(name: "fname")  String fname, @JsonKey(name: "gender")  String gender, @JsonKey(name: "message")  String message, @JsonKey(name: "coin")  int coin, @JsonKey(name: "album_favorites")  int albumFavorites, @JsonKey(name: "s")  String s, @JsonKey(name: "level_name")  String levelName, @JsonKey(name: "level")  int level, @JsonKey(name: "nextLevelExp")  int nextLevelExp, @JsonKey(name: "exp")  String exp, @JsonKey(name: "expPercent")  double expPercent, @JsonKey(name: "badges")  List<dynamic> badges, @JsonKey(name: "album_favorites_max")  int albumFavoritesMax, @JsonKey(name: "ad_free")  bool adFree, @JsonKey(name: "ad_free_before")  String adFreeBefore, @JsonKey(name: "charge")  String charge, @JsonKey(name: "jar")  String jar, @JsonKey(name: "invitation_qrcode")  String invitationQrcode, @JsonKey(name: "invitation_url")  String invitationUrl, @JsonKey(name: "invited_cnt")  String invitedCnt, @JsonKey(name: "jwttoken")  String jwttoken)  $default,) {final _that = this;
switch (_that) {
case _JmUserInfoJson():
return $default(_that.uid,_that.username,_that.email,_that.emailverified,_that.photo,_that.fname,_that.gender,_that.message,_that.coin,_that.albumFavorites,_that.s,_that.levelName,_that.level,_that.nextLevelExp,_that.exp,_that.expPercent,_that.badges,_that.albumFavoritesMax,_that.adFree,_that.adFreeBefore,_that.charge,_that.jar,_that.invitationQrcode,_that.invitationUrl,_that.invitedCnt,_that.jwttoken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "uid")  String uid, @JsonKey(name: "username")  String username, @JsonKey(name: "email")  String email, @JsonKey(name: "emailverified")  String emailverified, @JsonKey(name: "photo")  String photo, @JsonKey(name: "fname")  String fname, @JsonKey(name: "gender")  String gender, @JsonKey(name: "message")  String message, @JsonKey(name: "coin")  int coin, @JsonKey(name: "album_favorites")  int albumFavorites, @JsonKey(name: "s")  String s, @JsonKey(name: "level_name")  String levelName, @JsonKey(name: "level")  int level, @JsonKey(name: "nextLevelExp")  int nextLevelExp, @JsonKey(name: "exp")  String exp, @JsonKey(name: "expPercent")  double expPercent, @JsonKey(name: "badges")  List<dynamic> badges, @JsonKey(name: "album_favorites_max")  int albumFavoritesMax, @JsonKey(name: "ad_free")  bool adFree, @JsonKey(name: "ad_free_before")  String adFreeBefore, @JsonKey(name: "charge")  String charge, @JsonKey(name: "jar")  String jar, @JsonKey(name: "invitation_qrcode")  String invitationQrcode, @JsonKey(name: "invitation_url")  String invitationUrl, @JsonKey(name: "invited_cnt")  String invitedCnt, @JsonKey(name: "jwttoken")  String jwttoken)?  $default,) {final _that = this;
switch (_that) {
case _JmUserInfoJson() when $default != null:
return $default(_that.uid,_that.username,_that.email,_that.emailverified,_that.photo,_that.fname,_that.gender,_that.message,_that.coin,_that.albumFavorites,_that.s,_that.levelName,_that.level,_that.nextLevelExp,_that.exp,_that.expPercent,_that.badges,_that.albumFavoritesMax,_that.adFree,_that.adFreeBefore,_that.charge,_that.jar,_that.invitationQrcode,_that.invitationUrl,_that.invitedCnt,_that.jwttoken);case _:
  return null;
...
@override@JsonKey(name: "jwttoken") final  String jwttoken;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,username,email,emailverified,photo,fname,gender,message,coin,albumFavorites,s,levelName,level,nextLevelExp,exp,expPercent,const DeepCollectionEquality().hash(_badges),albumFavoritesMax,adFree,adFreeBefore,charge,jar,invitationQrcode,invitationUrl,invitedCnt,jwttoken]);
