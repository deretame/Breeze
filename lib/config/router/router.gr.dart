...
import 'package:material_ui/material_ui.dart' as _i44;
...
import 'package:zephyr/page/search/cubit/search_cubit.dart' as _i53;
...
import 'package:zephyr/page/search_aggregate/view/search_aggregate_result_page.dart'
    as _i34;
import 'package:zephyr/page/search_result/bloc/search_bloc.dart' as _i52;
import 'package:zephyr/page/search_result/search_result.dart' as _i54;
...
class BookshelfSettingRoute extends _i43.PageRouteInfo<void> {
  const BookshelfSettingRoute({List<_i43.PageRouteInfo>? children})
...
class ComicInfoRouteArgs {
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        ...
        from == other.from &&
        type == other.type &&
        const _i46.MapEquality<String, dynamic>().equals(
          extern,
          other.extern,
        ) &&
  ...
  int get hashCode =>
      ...
      from.hashCode ^
      type.hashCode ^
      const _i46.MapEquality<String, dynamic>().hash(extern) ^
...
class LoginRouteArgs {
  ...
  int get hashCode =>
      key.hashCode ^
      from.hashCode ^
      const _i46.MapEquality<String, dynamic>().hash(loginScheme) ^
      const _i46.MapEquality<String, dynamic>().hash(loginData);
}
...
class PluginFunctionRoute extends _i43.PageRouteInfo<PluginFunctionRouteArgs> {
  PluginFunctionRoute({
    ...
    required _i51.Future<void> Function(Map<String, dynamic>) onAction,
    List<_i43.PageRouteInfo>? children,
  }) : super(
...
class PluginFunctionRouteArgs {
  ...
  final _i51.Future<void> Function(Map<String, dynamic>) onAction;
...
class SearchAggregateResultRoute
  ...
  SearchAggregateResultRoute({
    _i44.Key? key,
    required _i52.SearchEvent searchEvent,
    _i53.SearchCubit? searchCubit,
...
class SearchAggregateResultRouteArgs {
  ...
  final _i52.SearchEvent searchEvent;

  final _i53.SearchCubit? searchCubit;
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        ...
        const _i46.MapEquality<String, bool>().equals(
          selectedSources,
  ...
  int get hashCode =>
      ...
      const _i46.MapEquality<String, bool>().hash(selectedSources);
}
...
class SearchRoute extends _i43.PageRouteInfo<SearchRouteArgs> {
  SearchRoute({
    _i44.Key? key,
    required _i53.SearchStates searchState,
...
class SearchRouteArgs {
  ...
  final _i53.SearchStates searchState;
