...
/// Adds pattern-matching-related methods to [JmComicInfoJson].
extension JmComicInfoJsonPatterns on JmComicInfoJson {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _JmComicInfoJson value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _JmComicInfoJson() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _JmComicInfoJson value)  $default,){
final _that = this;
switch (_that) {
case _JmComicInfoJson():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _JmComicInfoJson value)?  $default,){
final _that = this;
switch (_that) {
case _JmComicInfoJson() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  int id, @JsonKey(name: "name")  String name, @JsonKey(name: "images")  List<dynamic> images, @JsonKey(name: "addtime")  String addtime, @JsonKey(name: "description")  String description, @JsonKey(name: "total_views")  String totalViews, @JsonKey(name: "likes")  String likes, @JsonKey(name: "series")  List<Series> series, @JsonKey(name: "series_id")  String seriesId, @JsonKey(name: "comment_total")  String commentTotal, @JsonKey(name: "author")  List<String> author, @JsonKey(name: "tags")  List<String> tags, @JsonKey(name: "works")  List<String> works, @JsonKey(name: "actors")  List<String> actors, @JsonKey(name: "related_list")  List<RelatedList> relatedList, @JsonKey(name: "liked")  bool liked, @JsonKey(name: "is_favorite")  bool isFavorite, @JsonKey(name: "is_aids")  bool isAids, @JsonKey(name: "price")  String price, @JsonKey(name: "purchased")  String purchased)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JmComicInfoJson() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  int id, @JsonKey(name: "name")  String name, @JsonKey(name: "images")  List<dynamic> images, @JsonKey(name: "addtime")  String addtime, @JsonKey(name: "description")  String description, @JsonKey(name: "total_views")  String totalViews, @JsonKey(name: "likes")  String likes, @JsonKey(name: "series")  List<Series> series, @JsonKey(name: "series_id")  String seriesId, @JsonKey(name: "comment_total")  String commentTotal, @JsonKey(name: "author")  List<String> author, @JsonKey(name: "tags")  List<String> tags, @JsonKey(name: "works")  List<String> works, @JsonKey(name: "actors")  List<String> actors, @JsonKey(name: "related_list")  List<RelatedList> relatedList, @JsonKey(name: "liked")  bool liked, @JsonKey(name: "is_favorite")  bool isFavorite, @JsonKey(name: "is_aids")  bool isAids, @JsonKey(name: "price")  String price, @JsonKey(name: "purchased")  String purchased)  $default,) {final _that = this;
switch (_that) {
case _JmComicInfoJson():
return $default(_that.id,_that.name,_that.images,_that.addtime,_that.description,_that.totalViews,_that.likes,_that.series,_that.seriesId,_that.commentTotal,_that.author,_that.tags,_that.works,_that.actors,_that.relatedList,_that.liked,_that.isFavorite,_that.isAids,_that.price,_that.purchased);case _:
  throw StateError('Unexpected subclass');
