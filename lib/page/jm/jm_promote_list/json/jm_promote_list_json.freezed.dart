...
/// Adds pattern-matching-related methods to [JmPromoteListJson].
extension JmPromoteListJsonPatterns on JmPromoteListJson {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _JmPromoteListJson value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _JmPromoteListJson() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _JmPromoteListJson value)  $default,){
final _that = this;
switch (_that) {
case _JmPromoteListJson():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _JmPromoteListJson value)?  $default,){
final _that = this;
switch (_that) {
case _JmPromoteListJson() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "total")  String total, @JsonKey(name: "list")  List<ListElement> list)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JmPromoteListJson() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "total")  String total, @JsonKey(name: "list")  List<ListElement> list)  $default,) {final _that = this;
switch (_that) {
case _JmPromoteListJson():
return $default(_that.total,_that.list);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "total")  String total, @JsonKey(name: "list")  List<ListElement> list)?  $default,) {final _that = this;
switch (_that) {
case _JmPromoteListJson() when $default != null:
return $default(_that.total,_that.list);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,author,name,category,categorySub,liked,isFavorite,updateAt);

@override
String toString() {
  return 'ListElement(id: $id, author: $author, name: $name, category: $category, categorySub: $categorySub, liked: $liked, isFavorite: $isFavorite, updateAt: $updateAt)';
}
...
@useResult
$Res call({
@JsonKey(name: "id") String id,@JsonKey(name: "author") String author,@JsonKey(name: "name") String name,@JsonKey(name: "category") Category category,@JsonKey(name: "category_sub") CategorySub categorySub,@JsonKey(name: "liked") bool liked,@JsonKey(name: "is_favorite") bool isFavorite,@JsonKey(name: "update_at") int updateAt
});
...
/// Create a copy of ListElement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? author = null,Object? name = null,Object? category = null,Object? categorySub = null,Object? liked = null,Object? isFavorite = null,Object? updateAt = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  String id, @JsonKey(name: "author")  String author, @JsonKey(name: "name")  String name, @JsonKey(name: "category")  Category category, @JsonKey(name: "category_sub")  CategorySub categorySub, @JsonKey(name: "liked")  bool liked, @JsonKey(name: "is_favorite")  bool isFavorite, @JsonKey(name: "update_at")  int updateAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ListElement() when $default != null:
return $default(_that.id,_that.author,_that.name,_that.category,_that.categorySub,_that.liked,_that.isFavorite,_that.updateAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  String id, @JsonKey(name: "author")  String author, @JsonKey(name: "name")  String name, @JsonKey(name: "category")  Category category, @JsonKey(name: "category_sub")  CategorySub categorySub, @JsonKey(name: "liked")  bool liked, @JsonKey(name: "is_favorite")  bool isFavorite, @JsonKey(name: "update_at")  int updateAt)  $default,) {final _that = this;
switch (_that) {
case _ListElement():
return $default(_that.id,_that.author,_that.name,_that.category,_that.categorySub,_that.liked,_that.isFavorite,_that.updateAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "id")  String id, @JsonKey(name: "author")  String author, @JsonKey(name: "name")  String name, @JsonKey(name: "category")  Category category, @JsonKey(name: "category_sub")  CategorySub categorySub, @JsonKey(name: "liked")  bool liked, @JsonKey(name: "is_favorite")  bool isFavorite, @JsonKey(name: "update_at")  int updateAt)?  $default,) {final _that = this;
switch (_that) {
case _ListElement() when $default != null:
return $default(_that.id,_that.author,_that.name,_that.category,_that.categorySub,_that.liked,_that.isFavorite,_that.updateAt);case _:
  return null;
...
class _ListElement implements ListElement {
  const _ListElement({@JsonKey(name: "id") required this.id, @JsonKey(name: "author") required this.author, @JsonKey(name: "name") required this.name, @JsonKey(name: "category") required this.category, @JsonKey(name: "category_sub") required this.categorySub, @JsonKey(name: "liked") required this.liked, @JsonKey(name: "is_favorite") required this.isFavorite, @JsonKey(name: "update_at") required this.updateAt});
...
/// Create a copy of ListElement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? author = null,Object? name = null,Object? category = null,Object? categorySub = null,Object? liked = null,Object? isFavorite = null,Object? updateAt = null,}) {
