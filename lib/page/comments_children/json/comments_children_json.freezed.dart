...
/// Adds pattern-matching-related methods to [CommentsChildrenJson].
extension CommentsChildrenJsonPatterns on CommentsChildrenJson {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CommentsChildrenJson value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CommentsChildrenJson() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CommentsChildrenJson value)  $default,){
final _that = this;
switch (_that) {
case _CommentsChildrenJson():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CommentsChildrenJson value)?  $default,){
final _that = this;
switch (_that) {
case _CommentsChildrenJson() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "_id")  String id, @JsonKey(name: "content")  String content, @JsonKey(name: "_user")  User user, @JsonKey(name: "_parent")  String parent, @JsonKey(name: "_comic")  String comic, @JsonKey(name: "totalComments")  int totalComments, @JsonKey(name: "isTop")  bool isTop, @JsonKey(name: "hide")  bool hide, @JsonKey(name: "created_at")  DateTime createdAt, @JsonKey(name: "id")  String docId, @JsonKey(name: "likesCount")  int likesCount, @JsonKey(name: "isLiked")  bool isLiked)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Doc() when $default != null:
return $default(_that.id,_that.content,_that.user,_that.parent,_that.comic,_that.totalComments,_that.isTop,_that.hide,_that.createdAt,_that.docId,_that.likesCount,_that.isLiked);case _:
  return orElse();
