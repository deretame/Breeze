...
class _SearchStatusState implements SearchStatusState {
  const _SearchStatusState({this.keyword = "", this.sort = "dd", final  List<String> categories = const <String>[], final  List<String> sources = const <String>[]}): _categories = categories,_sources = sources;
