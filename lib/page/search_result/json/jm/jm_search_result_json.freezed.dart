...
part of 'jm_search_result_json.dart';
...
$JmSearchResultJsonCopyWith<JmSearchResultJson> get copyWith => _$JmSearchResultJsonCopyWithImpl<JmSearchResultJson>(this as JmSearchResultJson, _$identity);

  /// Serializes this JmSearchResultJson to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JmSearchResultJson&&(identical(other.searchQuery, searchQuery) || other.searchQuery == searchQuery)&&(identical(other.total, total) || other.total == total)&&const DeepCollectionEquality().equals(other.content, content));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,searchQuery,total,const DeepCollectionEquality().hash(content));

@override
String toString() {
  return 'JmSearchResultJson(searchQuery: $searchQuery, total: $total, content: $content)';
}
...
/// @nodoc
abstract mixin class $JmSearchResultJsonCopyWith<$Res>  {
...
/// @nodoc
class _$JmSearchResultJsonCopyWithImpl<$Res>
    implements $JmSearchResultJsonCopyWith<$Res> {
  _$JmSearchResultJsonCopyWithImpl(this._self, this._then);

  final JmSearchResultJson _self;
  final $Res Function(JmSearchResultJson) _then;
...
/// Adds pattern-matching-related methods to [JmSearchResultJson].
extension JmSearchResultJsonPatterns on JmSearchResultJson {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _JmSearchResultJson value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _JmSearchResultJson() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _JmSearchResultJson value)  $default,){
final _that = this;
switch (_that) {
case _JmSearchResultJson():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _JmSearchResultJson value)?  $default,){
final _that = this;
switch (_that) {
case _JmSearchResultJson() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "search_query")  String searchQuery, @JsonKey(name: "total")  String total, @JsonKey(name: "content")  List<Content> content)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JmSearchResultJson() when $default != null:
return $default(_that.searchQuery,_that.total,_that.content);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "search_query")  String searchQuery, @JsonKey(name: "total")  String total, @JsonKey(name: "content")  List<Content> content)  $default,) {final _that = this;
switch (_that) {
case _JmSearchResultJson():
return $default(_that.searchQuery,_that.total,_that.content);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "search_query")  String searchQuery, @JsonKey(name: "total")  String total, @JsonKey(name: "content")  List<Content> content)?  $default,) {final _that = this;
switch (_that) {
case _JmSearchResultJson() when $default != null:
return $default(_that.searchQuery,_that.total,_that.content);case _:
  return null;
...
@pragma('vm:prefer-inline')
_$JmSearchResultJsonCopyWith<_JmSearchResultJson> get copyWith => __$JmSearchResultJsonCopyWithImpl<_JmSearchResultJson>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$JmSearchResultJsonToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _JmSearchResultJson&&(identical(other.searchQuery, searchQuery) || other.searchQuery == searchQuery)&&(identical(other.total, total) || other.total == total)&&const DeepCollectionEquality().equals(other._content, _content));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,searchQuery,total,const DeepCollectionEquality().hash(_content));
...
/// @nodoc
abstract mixin class _$JmSearchResultJsonCopyWith<$Res> implements $JmSearchResultJsonCopyWith<$Res> {
...
/// @nodoc
class __$JmSearchResultJsonCopyWithImpl<$Res>
    implements _$JmSearchResultJsonCopyWith<$Res> {
  __$JmSearchResultJsonCopyWithImpl(this._self, this._then);

  final _JmSearchResultJson _self;
  final $Res Function(_JmSearchResultJson) _then;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,author,const DeepCollectionEquality().hash(description),name,image,category,categorySub,liked,isFavorite,updateAt);

@override
String toString() {
  return 'Content(id: $id, author: $author, description: $description, name: $name, image: $image, category: $category, categorySub: $categorySub, liked: $liked, isFavorite: $isFavorite, updateAt: $updateAt)';
}
...
switch (_that) {
case _Content() when $default != null:
return $default(_that.id,_that.author,_that.description,_that.name,_that.image,_that.category,_that.categorySub,_that.liked,_that.isFavorite,_that.updateAt);case _:
  return orElse();
