...
$JmSuggestionJsonCopyWith<JmSuggestionJson> get copyWith => _$JmSuggestionJsonCopyWithImpl<JmSuggestionJson>(this as JmSuggestionJson, _$identity);

  /// Serializes this JmSuggestionJson to a JSON map.
...
@override
String toString() {
  return 'JmSuggestionJson(id: $id, author: $author, name: $name, image: $image, category: $category, categorySub: $categorySub, liked: $liked, isFavorite: $isFavorite, updateAt: $updateAt)';
}
...
/// @nodoc
abstract mixin class $JmSuggestionJsonCopyWith<$Res>  {
...
/// @nodoc
class _$JmSuggestionJsonCopyWithImpl<$Res>
    implements $JmSuggestionJsonCopyWith<$Res> {
  _$JmSuggestionJsonCopyWithImpl(this._self, this._then);

  final JmSuggestionJson _self;
  final $Res Function(JmSuggestionJson) _then;
...
/// Adds pattern-matching-related methods to [JmSuggestionJson].
extension JmSuggestionJsonPatterns on JmSuggestionJson {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _JmSuggestionJson value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _JmSuggestionJson() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _JmSuggestionJson value)  $default,){
final _that = this;
switch (_that) {
case _JmSuggestionJson():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _JmSuggestionJson value)?  $default,){
final _that = this;
switch (_that) {
case _JmSuggestionJson() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$JmSuggestionJsonCopyWith<_JmSuggestionJson> get copyWith => __$JmSuggestionJsonCopyWithImpl<_JmSuggestionJson>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$JmSuggestionJsonToJson(this, );
}
...
/// @nodoc
abstract mixin class _$JmSuggestionJsonCopyWith<$Res> implements $JmSuggestionJsonCopyWith<$Res> {
...
/// @nodoc
class __$JmSuggestionJsonCopyWithImpl<$Res>
    implements _$JmSuggestionJsonCopyWith<$Res> {
  __$JmSuggestionJsonCopyWithImpl(this._self, this._then);

  final _JmSuggestionJson _self;
  final $Res Function(_JmSuggestionJson) _then;
