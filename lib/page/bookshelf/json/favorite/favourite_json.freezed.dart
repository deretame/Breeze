...
abstract class $FavouriteJsonCopyWith<$Res> {
  factory $FavouriteJsonCopyWith(
          FavouriteJson value, $Res Function(FavouriteJson) then) =
...
abstract class _$$FavouriteJsonImplCopyWith<$Res>
  ...
  factory _$$FavouriteJsonImplCopyWith(
          _$FavouriteJsonImpl value, $Res Function(_$FavouriteJsonImpl) then) =
...
class __$$FavouriteJsonImplCopyWithImpl<$Res>
  ...
  __$$FavouriteJsonImplCopyWithImpl(
      _$FavouriteJsonImpl _value, $Res Function(_$FavouriteJsonImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FavouriteJsonImpl(
      code: null == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$FavouriteJsonImpl implements _FavouriteJson {
  ...
  Map<String, dynamic> toJson() {
    return _$$FavouriteJsonImplToJson(
      this,
    );
  }
}
...
abstract class _FavouriteJson implements FavouriteJson {
  const factory _FavouriteJson(
      ...
      @JsonKey(name: "data") required final Data data}) = _$FavouriteJsonImpl;
