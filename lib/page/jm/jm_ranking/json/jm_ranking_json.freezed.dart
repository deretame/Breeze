...
/// Adds pattern-matching-related methods to [JmRankingJson].
extension JmRankingJsonPatterns on JmRankingJson {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _JmRankingJson value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _JmRankingJson() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _JmRankingJson value)  $default,){
final _that = this;
switch (_that) {
case _JmRankingJson():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _JmRankingJson value)?  $default,){
final _that = this;
switch (_that) {
case _JmRankingJson() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "search_query")  String searchQuery, @JsonKey(name: "total")  String total, @JsonKey(name: "content")  List<Content> content, @JsonKey(name: "tags")  List<String> tags)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JmRankingJson() when $default != null:
return $default(_that.searchQuery,_that.total,_that.content,_that.tags);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "search_query")  String searchQuery, @JsonKey(name: "total")  String total, @JsonKey(name: "content")  List<Content> content, @JsonKey(name: "tags")  List<String> tags)  $default,) {final _that = this;
switch (_that) {
case _JmRankingJson():
return $default(_that.searchQuery,_that.total,_that.content,_that.tags);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "search_query")  String searchQuery, @JsonKey(name: "total")  String total, @JsonKey(name: "content")  List<Content> content, @JsonKey(name: "tags")  List<String> tags)?  $default,) {final _that = this;
switch (_that) {
case _JmRankingJson() when $default != null:
return $default(_that.searchQuery,_that.total,_that.content,_that.tags);case _:
  return null;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  dynamic id, @JsonKey(name: "title")  dynamic title)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategorySub() when $default != null:
return $default(_that.id,_that.title);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "id")  dynamic id, @JsonKey(name: "title")  dynamic title)  $default,) {final _that = this;
switch (_that) {
case _CategorySub():
return $default(_that.id,_that.title);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "id")  dynamic id, @JsonKey(name: "title")  dynamic title)?  $default,) {final _that = this;
switch (_that) {
case _CategorySub() when $default != null:
return $default(_that.id,_that.title);case _:
  return null;
