...
mixin _$GlobalSetting on _GlobalSetting, Store {
  ...
  late final _$comicReadTopContainerAtom = Atom(
    name: '_GlobalSetting.comicReadTopContainer',
    context: context,
  );
  ...
  set comicReadTopContainer(bool value) {
    _$comicReadTopContainerAtom.reportWrite(
      value,
      super.comicReadTopContainer,
      () {
  ...
  late final _$readModeAtom = Atom(
    name: '_GlobalSetting.readMode',
    context: context,
  );
