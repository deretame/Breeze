...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        34 => wire__crate__api__qjs__test_hello_world_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__simple__zstd_compress_bytes_impl(port, ptr, rust_vec_len, data_len),
        37 => {
