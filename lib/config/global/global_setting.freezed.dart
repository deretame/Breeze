...
mixin _$GlobalSettingState {
 ...
 bool get dynamicColor; ThemeMode get themeMode; bool get themeType; bool get isAMOLED;// 应用 ColorConverter
@ColorConverter() Color get seedColor;@ColorConverter() Color get backgroundColor;@ColorConverter() Color get textColor; int get themeInitState;// 应用 LocaleConverter
@LocaleConverter() Locale get locale; int get welcomePageNum; String get webdavHost; String get webdavUsername; String get webdavPassword; bool get autoSync; bool get syncNotify; bool get shade; bool get comicReadTopContainer; int get readMode; List<String> get maskedKeywords; String get socks5Proxy; bool get needCleanCache; int get comicChoice; bool get disableBika;
...
@useResult
$Res call({
 bool dynamicColor, ThemeMode themeMode, bool themeType, bool isAMOLED,@ColorConverter() Color seedColor,@ColorConverter() Color backgroundColor,@ColorConverter() Color textColor, int themeInitState,@LocaleConverter() Locale locale, int welcomePageNum, String webdavHost, String webdavUsername, String webdavPassword, bool autoSync, bool syncNotify, bool shade, bool comicReadTopContainer, int readMode, List<String> maskedKeywords, String socks5Proxy, bool needCleanCache, int comicChoice, bool disableBika
});
...
/// Create a copy of GlobalSettingState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dynamicColor = null,Object? themeMode = null,Object? themeType = null,Object? isAMOLED = null,Object? seedColor = null,Object? backgroundColor = null,Object? textColor = null,Object? themeInitState = null,Object? locale = null,Object? welcomePageNum = null,Object? webdavHost = null,Object? webdavUsername = null,Object? webdavPassword = null,Object? autoSync = null,Object? syncNotify = null,Object? shade = null,Object? comicReadTopContainer = null,Object? readMode = null,Object? maskedKeywords = null,Object? socks5Proxy = null,Object? needCleanCache = null,Object? comicChoice = null,Object? disableBika = null,}) {
...
as ThemeMode,themeType: null == themeType ? _self.themeType : themeType // ignore: cast_nullable_to_non_nullable
...
as bool,shade: null == shade ? _self.shade : shade // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool dynamicColor,  ThemeMode themeMode,  bool themeType,  bool isAMOLED, @ColorConverter()  Color seedColor, @ColorConverter()  Color backgroundColor, @ColorConverter()  Color textColor,  int themeInitState, @LocaleConverter()  Locale locale,  int welcomePageNum,  String webdavHost,  String webdavUsername,  String webdavPassword,  bool autoSync,  bool syncNotify,  bool shade,  bool comicReadTopContainer,  int readMode,  List<String> maskedKeywords,  String socks5Proxy,  bool needCleanCache,  int comicChoice,  bool disableBika)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GlobalSettingState() when $default != null:
return $default(_that.dynamicColor,_that.themeMode,_that.themeType,_that.isAMOLED,_that.seedColor,_that.backgroundColor,_that.textColor,_that.themeInitState,_that.locale,_that.welcomePageNum,_that.webdavHost,_that.webdavUsername,_that.webdavPassword,_that.autoSync,_that.syncNotify,_that.shade,_that.comicReadTopContainer,_that.readMode,_that.maskedKeywords,_that.socks5Proxy,_that.needCleanCache,_that.comicChoice,_that.disableBika);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool dynamicColor,  ThemeMode themeMode,  bool themeType,  bool isAMOLED, @ColorConverter()  Color seedColor, @ColorConverter()  Color backgroundColor, @ColorConverter()  Color textColor,  int themeInitState, @LocaleConverter()  Locale locale,  int welcomePageNum,  String webdavHost,  String webdavUsername,  String webdavPassword,  bool autoSync,  bool syncNotify,  bool shade,  bool comicReadTopContainer,  int readMode,  List<String> maskedKeywords,  String socks5Proxy,  bool needCleanCache,  int comicChoice,  bool disableBika)  $default,) {final _that = this;
switch (_that) {
case _GlobalSettingState():
return $default(_that.dynamicColor,_that.themeMode,_that.themeType,_that.isAMOLED,_that.seedColor,_that.backgroundColor,_that.textColor,_that.themeInitState,_that.locale,_that.welcomePageNum,_that.webdavHost,_that.webdavUsername,_that.webdavPassword,_that.autoSync,_that.syncNotify,_that.shade,_that.comicReadTopContainer,_that.readMode,_that.maskedKeywords,_that.socks5Proxy,_that.needCleanCache,_that.comicChoice,_that.disableBika);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool dynamicColor,  ThemeMode themeMode,  bool themeType,  bool isAMOLED, @ColorConverter()  Color seedColor, @ColorConverter()  Color backgroundColor, @ColorConverter()  Color textColor,  int themeInitState, @LocaleConverter()  Locale locale,  int welcomePageNum,  String webdavHost,  String webdavUsername,  String webdavPassword,  bool autoSync,  bool syncNotify,  bool shade,  bool comicReadTopContainer,  int readMode,  List<String> maskedKeywords,  String socks5Proxy,  bool needCleanCache,  int comicChoice,  bool disableBika)?  $default,) {final _that = this;
switch (_that) {
case _GlobalSettingState() when $default != null:
return $default(_that.dynamicColor,_that.themeMode,_that.themeType,_that.isAMOLED,_that.seedColor,_that.backgroundColor,_that.textColor,_that.themeInitState,_that.locale,_that.welcomePageNum,_that.webdavHost,_that.webdavUsername,_that.webdavPassword,_that.autoSync,_that.syncNotify,_that.shade,_that.comicReadTopContainer,_that.readMode,_that.maskedKeywords,_that.socks5Proxy,_that.needCleanCache,_that.comicChoice,_that.disableBika);case _:
  return null;
...
class _GlobalSettingState implements GlobalSettingState {
  const _GlobalSettingState({this.dynamicColor = true, this.themeMode = ThemeMode.system, this.themeType = true, this.isAMOLED = true, @ColorConverter() this.seedColor = const Color(0xFFEF5350), @ColorConverter() this.backgroundColor = Colors.white, @ColorConverter() this.textColor = Colors.black, this.themeInitState = 0, @LocaleConverter() this.locale = const Locale('zh', 'CN'), this.welcomePageNum = 0, this.webdavHost = '', this.webdavUsername = '', this.webdavPassword = '', this.autoSync = true, this.syncNotify = true, this.shade = true, this.comicReadTopContainer = true, this.readMode = 0, final  List<String> maskedKeywords = const [""], this.socks5Proxy = '', this.needCleanCache = false, this.comicChoice = 1, this.disableBika = false}): _maskedKeywords = maskedKeywords;
...
@override@JsonKey() final  bool themeType;
...
@override@JsonKey()@ColorConverter() final  Color textColor;
...
@override@JsonKey() final  bool shade;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,dynamicColor,themeMode,themeType,isAMOLED,seedColor,backgroundColor,textColor,themeInitState,locale,welcomePageNum,webdavHost,webdavUsername,webdavPassword,autoSync,syncNotify,shade,comicReadTopContainer,readMode,const DeepCollectionEquality().hash(_maskedKeywords),socks5Proxy,needCleanCache,comicChoice,disableBika]);
