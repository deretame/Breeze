...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1014366366;
...
fn wire__crate__api__simple__async_http_get_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok = crate::api::simple::async_http_get(&api_url).await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__simple__async_http_get_impl(port, ptr, rust_vec_len, data_len),
        ...
        6 => wire__crate__api__simple__pack_folder_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__simple__sleep_test_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__simple__stream_test_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        9 => wire__crate__api__simple__traditional_to_simplified_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
