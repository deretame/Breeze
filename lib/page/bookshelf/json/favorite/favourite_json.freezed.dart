...
/// Adds pattern-matching-related methods to [FavouriteJson].
extension FavouriteJsonPatterns on FavouriteJson {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FavouriteJson value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FavouriteJson() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FavouriteJson value)  $default,){
final _that = this;
switch (_that) {
case _FavouriteJson():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FavouriteJson value)?  $default,){
final _that = this;
switch (_that) {
case _FavouriteJson() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "pages")  int pages, @JsonKey(name: "total")  int total, @JsonKey(name: "docs")  List<Doc> docs, @JsonKey(name: "page")  int page, @JsonKey(name: "limit")  int limit)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Comics() when $default != null:
return $default(_that.pages,_that.total,_that.docs,_that.page,_that.limit);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "pages")  int pages, @JsonKey(name: "total")  int total, @JsonKey(name: "docs")  List<Doc> docs, @JsonKey(name: "page")  int page, @JsonKey(name: "limit")  int limit)  $default,) {final _that = this;
switch (_that) {
case _Comics():
return $default(_that.pages,_that.total,_that.docs,_that.page,_that.limit);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "pages")  int pages, @JsonKey(name: "total")  int total, @JsonKey(name: "docs")  List<Doc> docs, @JsonKey(name: "page")  int page, @JsonKey(name: "limit")  int limit)?  $default,) {final _that = this;
switch (_that) {
case _Comics() when $default != null:
return $default(_that.pages,_that.total,_that.docs,_that.page,_that.limit);case _:
  return null;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "_id")  String id, @JsonKey(name: "title")  String title, @JsonKey(name: "author")  String author, @JsonKey(name: "totalViews")  int totalViews, @JsonKey(name: "totalLikes")  int totalLikes, @JsonKey(name: "pagesCount")  int pagesCount, @JsonKey(name: "epsCount")  int epsCount, @JsonKey(name: "finished")  bool finished, @JsonKey(name: "categories")  List<String> categories, @JsonKey(name: "thumb")  Thumb thumb, @JsonKey(name: "likesCount")  int likesCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Doc() when $default != null:
return $default(_that.id,_that.title,_that.author,_that.totalViews,_that.totalLikes,_that.pagesCount,_that.epsCount,_that.finished,_that.categories,_that.thumb,_that.likesCount);case _:
  return orElse();
