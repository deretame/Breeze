...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1304383893;
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, crate::api::error::FrbError>(
                    (move || async move {
                        let output_ok = crate::api::qjs::qjs_fetch_image_bytes(api_url).await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        4 => wire__crate__api__memory__get_rust_memory_info_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__memory__get_rust_memory_summary_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        8 => wire__crate__api__qjs__jm_request_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__simple__pack_folder_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__simple__pack_folder_zip_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__qjs__qjs_call_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__qjs__qjs_call_cancel_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__qjs__qjs_call_once_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__qjs__qjs_call_start_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__qjs__qjs_call_wait_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__qjs__qjs_clear_bundle_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__qjs__qjs_current_bundle_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__qjs__qjs_drop_runtime_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__qjs__qjs_fetch_image_bytes_impl(port, ptr, rust_vec_len, data_len),
        ...
        25 => wire__crate__api__qjs__set_socks5_proxy_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__user_utils__setup_default_user_utils_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        27 => wire__crate__api__simple__sleep_test_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__system__start_shutdown_listener_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        29 => wire__crate__api__simple__stream_test_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__qjs__test_hello_world_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__simple__zstd_compress_bytes_impl(port, ptr, rust_vec_len, data_len),
        33 => {
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        31 => wire__crate__api__simple__traditional_to_simplified_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
