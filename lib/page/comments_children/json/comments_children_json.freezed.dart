...
abstract class $CommentsChildrenJsonCopyWith<$Res> {
  factory $CommentsChildrenJsonCopyWith(CommentsChildrenJson value,
...
abstract class _$$CommentsChildrenJsonImplCopyWith<$Res>
    implements $CommentsChildrenJsonCopyWith<$Res> {
  factory _$$CommentsChildrenJsonImplCopyWith(_$CommentsChildrenJsonImpl value,
...
class __$$CommentsChildrenJsonImplCopyWithImpl<$Res>
  ...
  __$$CommentsChildrenJsonImplCopyWithImpl(_$CommentsChildrenJsonImpl _value,
  ...
  $Res call({
    ...
    return _then(_$CommentsChildrenJsonImpl(
      code: null == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$CommentsChildrenJsonImpl implements _CommentsChildrenJson {
  ...
  Map<String, dynamic> toJson() {
    return _$$CommentsChildrenJsonImplToJson(
      this,
    );
  }
}
...
class _$DocImpl implements _Doc {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, content, user, parent, comic,
      totalComments, isTop, hide, createdAt, docId, likesCount, isLiked);
