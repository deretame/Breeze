...
Future<bool>  isQjsRuntimeInitialized({required String name }) => RustLib.instance.api.crateApiQjsIsQjsRuntimeInitialized(name: name);
...
void  registerFunction({required String functionName , required FutureOr<String> Function(String) dartCallback }) => RustLib.instance.api.crateApiQjsRegisterFunction(functionName: functionName, dartCallback: dartCallback);

void  initRustFunctions() => RustLib.instance.api.crateApiQjsInitRustFunctions();

String  openccConvert({required String text , required String config }) => RustLib.instance.api.crateApiQjsOpenccConvert(text: text, config: config);
