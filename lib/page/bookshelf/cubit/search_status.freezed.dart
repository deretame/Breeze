...
mixin _$SearchStatusState {
 ...
 String get keyword; String get sort; List<String> get sources;
...
@useResult
$Res call({
 String keyword, String sort, List<String> sources
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String keyword,  String sort,  List<String> sources)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchStatusState() when $default != null:
return $default(_that.keyword,_that.sort,_that.sources);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String keyword,  String sort,  List<String> sources)  $default,) {final _that = this;
switch (_that) {
case _SearchStatusState():
return $default(_that.keyword,_that.sort,_that.sources);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String keyword,  String sort,  List<String> sources)?  $default,) {final _that = this;
switch (_that) {
case _SearchStatusState() when $default != null:
return $default(_that.keyword,_that.sort,_that.sources);case _:
  return null;
...
/// Create a copy of SearchStatusState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? keyword = null,Object? sort = null,Object? sources = null,}) {
